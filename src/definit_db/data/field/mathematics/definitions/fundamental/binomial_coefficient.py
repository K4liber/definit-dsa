...
class _BinomialCoefficient(Definition):
    def _get_content(self) -> str:
        return f"""
A {NUMBER.key.get_reference()} that counts how many ways to choose k {ITEM.key.get_reference("items")} 
...
This count, written "5 choose 2", is the binomial coefficient for "n = 5" and "k = 2", 
