...
using a {SET.key.get_reference(phrase="set")} of symbols and rules. Positional numeral systems are characterized 
by their {RADIX.key.get_reference("radix")} — the count of {DISTINCTNESS.key.get_reference(phrase="distinct")} 
symbols available.
