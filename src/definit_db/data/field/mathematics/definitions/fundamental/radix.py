...
class _Radix(Definition):
    def _get_content(self) -> str:
        return f"""
A radix is the base of a positional {NUMBER.key.get_reference("number")} system. It is the count of unique
digits, including zero, used to represent numbers in that system.
