...
class _Graph(Definition):
    def _get_content(self) -> str:
        return f"""
Graphs are used to model pairwise {RELATION.key.get_reference(phrase="relations")} between 
{OBJECT.key.get_reference(phrase="objects")}. A graph is made up of {NODE.key.get_reference(phrase="nodes")} and 
{EDGE.key.get_reference(phrase="edges")}. Graphs can represent various types of relationships in different fields.
